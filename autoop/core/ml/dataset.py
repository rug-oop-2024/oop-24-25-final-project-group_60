...
class Dataset(Artifact):
    """Represents a dataset artifact in the system, extending the Artifact class.
    """
    ...
    @staticmethod
    def from_dataframe(data: pd.DataFrame, name: str, asset_path: str, version: str="1_0_0") -> 'Dataset':
        ...
        Args:
            ...
            version (str, optional): The version of the dataset. Defaults to "1_0_0".
